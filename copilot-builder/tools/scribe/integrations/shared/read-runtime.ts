 ...
 * its CONFIG FILE — so a config in the repo root writes to `<repo>/.scribe/<source>/`.
 *
 * `.scribe/` is gitignored, and that is the point rather than a convenience: what
