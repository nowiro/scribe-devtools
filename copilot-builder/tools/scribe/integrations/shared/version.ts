...
// 1.3.1: the tool is named `scribe` — the provenance line written into upstream content
// changed accordingly.
// 1.4.0: the default output directory moved from `./.cache/<source>` to `./.scribe/<source>`
...
// The provenance line drops "apply" ("narzędzia scribe v…"). Deliberately UNCHANGED:
