...
Wynik ląduje w `.scribe/jira/<data>/<nazwa-snapshotu>/` — po jednym pliku `.md` (czytelny)
...
`.scribe/http-log/<skrypt>-<stempel>-<pid>.jsonl` (katalog zmienia `EXTRACT_HTTP_LOG_DIR`,
...
Zaktualizowano / Dodano za pomocą narzędzia scribe v…_") — widać ją już w dry-runie.
