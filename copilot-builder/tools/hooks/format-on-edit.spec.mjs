...
describe('formatTarget', () => {
  it('formats a source file written by an edit tool, as an absolute path', () => {
    ...
    expect(formatTarget('apply_patch', '--write.js', ROOT)).toBe(path.join(ROOT, '--write.js'));
  });
  ...
  it('skips files Biome does not own and paths outside the repository', () => {
    expect(formatTarget('create_file', 'README.md', ROOT)).toBeNull();
    expect(formatTarget('create_file', 'apps/demo/src/app/app.html', ROOT)).toBeNull();
